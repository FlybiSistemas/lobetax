    ...
    <table class="table-list">
        <thead>
            <tr class="titulos" style="display: contents;">
                <th>Iafis <img class="icon-grey filter-icon filter_iafis" src="{{ isset($searchData['filter_iafis']) ? asset('img/new/icons/remove-filter.ico') : '' }}" alt=""></th>
                <th>Aplica  <img class="icon-grey filter-icon filter_aplica" src="{{ isset($searchData['filter_aplica']) ? asset('img/new/icons/remove-filter.ico') : '' }}" alt=""></th>
                <th>Icms  <img class="icon-grey filter-icon filter_icms" src="{{ isset($searchData['filter_icms']) ? asset('img/new/icons/remove-filter.ico') : '' }}" alt=""></th>
                <th>Icmsst  <img class="icon-grey filter-icon filter_icmsst" src="{{ isset($searchData['filter_icmsst']) ? asset('img/new/icons/remove-filter.ico') : '' }}" alt=""></th>
                <th width="100">Ações<img class="filter-icon" src="" alt=""></th>
            </tr>
            <tr>
                <th><input class="form-control" name="filter_iafis" type="text" style="display:none;" value="{{ isset($searchData['filter_iafis']) ? $searchData['filter_iafis'] : '' }}"></th>
                <th><input class="form-control" name="filter_aplica" type="text" style="display:none;" value="{{ isset($searchData['filter_aplica']) ? $searchData['filter_aplica'] : '' }}"></th>
                <th><input class="form-control" name="filter_icms" type="text" style="display:none;" value="{{ isset($searchData['filter_icms']) ? $searchData['filter_icms'] : '' }}"></th>
                <th><input class="form-control" name="filter_icmsst" type="text" style="display:none;" value="{{ isset($searchData['filter_icmsst']) ? $searchData['filter_icmsst'] : '' }}"></th>
                <th></th>
            </tr>
        </thead>
