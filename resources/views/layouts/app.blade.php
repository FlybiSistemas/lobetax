...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/app-Bo76MMF8.css') }}">
    <!-- Scripts -->
...
<div class="modal fade show" id="modalBasic" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-modal="true" role="dialog">
...
<div class="modal fade show" id="modalSub" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true" aria-modal="true" role="dialog">
    <div class="modal-dialog" role="document" style="box-shadow: 0 5px 15px rgba(0,0,0,.5); top: 10px; left: 10px;">
        <div class="modal-content">
...
<div class="modal fade show" id="modalDelete" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-modal="true" role="dialog" style="display: none;">
